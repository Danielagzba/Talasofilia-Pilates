                ...
                <div className="container px-4 md:px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-muted-foreground max-w-2xl mx-auto">
                            Meet our team of certified Pilates instructors
                            dedicated to guiding you on your wellness journey.
                        </p>
                    </div>
                    ...
                    <div className="mt-20 text-center">
                        <h2 className="font-serif text-2xl md:text-3xl font-light mb-6">
                            Join Our{' '}
                            <span className="font-medium italic">Team</span>
                        </h2>
                        <p className="text-muted-foreground max-w-2xl mx-auto mb-8">
                            We're always looking for passionate, certified
                            Pilates instructors to join our growing team. If
                            you're interested in teaching at Estudio Pilates,
