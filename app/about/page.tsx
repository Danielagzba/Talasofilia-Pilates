    ...
    <div className="pt-16">
      ...
      <section className="relative h-[50vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            src="dcb45de9-6bbf-4c6b-8ed6-a683dd5b5300"
            alt="Pilates studio"
            fill
        ...
        <div className="container px-4 md:px-6">
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-4xl mx-auto">
            <div className="relative h-[400px] md:h-[500px]">
              <Image
                src="d250a973-e3e8-41d6-541f-5ef77bb85b00"
                alt="Studio founder"
                fill
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="relative h-[200px]">
                <Image
                  src="2f856696-ae20-48ce-c560-b5d617034900"
                  alt="Studio interior"
                  fill
                  className="object-cover"
                />
              ...
              <div className="relative h-[200px]">
                <Image
                  src="7cbb850a-6f02-41ce-eedd-e87aee785600"
              ...
              <div className="relative h-[200px]">
                <Image
                  src="9ce917e3-3460-4127-425e-95453bd88900"
                  alt="Mat class area"
                  fill
                  className="object-cover"
                />
              ...
              <div className="relative h-[200px]">
                <Image
                  src="e86ef0b4-516c-478c-7136-0114ec416800"
