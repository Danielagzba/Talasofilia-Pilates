                ...
                <div className="container relative z-10 px-4 md:px-6">
                    <div className="max-w-3xl mx-auto text-center text-white">
                        ...
                        <p className="text-lg md:text-xl opacity-90 max-w-xl mx-auto">
                            Transparent pricing options designed to fit your
                            lifestyle and wellness journey.
                        </p>
                    </div>
                </div>
            </section>
                ...
                <div className="container px-4 md:px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-muted-foreground max-w-2xl mx-auto">
                            Join us for individual classes with no long-term
                            commitment.
                        </p>
                    </div>
            ...
            <section className="py-20 md:py-32 bg-stone-100">
                <div className="container px-4 md:px-6">
                    <div className="text-center mb-16">
                        <h2 className="font-serif text-3xl md:text-4xl font-light mb-4">
                            Class{' '}
                            <span className="font-medium italic">Packages</span>
                        </h2>
                        <p className="text-muted-foreground max-w-2xl mx-auto">
            ...
            <section className="py-20 md:py-32">
                <div className="container px-4 md:px-6">
                    <div className="text-center mb-16">
                        <h2 className="font-serif text-3xl md:text-4xl font-light mb-4">
                            Pricing{' '}
                            <span className="font-medium italic">FAQ</span>
                        </h2>
                        <p className="text-muted-foreground max-w-2xl mx-auto">
                            Common questions about our pricing, packages, and
                            policies.
                        </p>
                    </div>
                ...
                <div className="container px-4 md:px-6">
                    <div className="max-w-3xl mx-auto text-center">
                        <h2 className="font-serif text-3xl md:text-4xl font-light mb-6">
                            Ready to{' '}
                            <span className="font-medium italic">Begin?</span>
                        </h2>
                        <p className="text-lg opacity-80 mb-8">
                            Take the first step toward a stronger, more balanced
                            you. Join us for a class or contact us to learn more
...
const pricingFaqs = [
    {
        ...
        answer: 'Yes, all class packages (4, 6, 8, and 12 classes) are valid for 3 months from the date of purchase.',
    },
    {
        question: 'Can I share my class package with a friend?',
        answer: 'Class packages are non-transferable and can only be used by the purchaser.',
    },
    {
    ...
    },
    {
        ...
        answer: 'No, there is no registration fee to join our studio. You only pay for the classes or packages you purchase.',
    },
    {
        question: 'Do you offer refunds?',
        answer: 'Class packages are non-refundable. In exceptional circumstances, please contact us to discuss your situation.',
    },
    // {
