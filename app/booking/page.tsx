                    ...
                    <div className="max-w-3xl mx-auto">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-muted-foreground">
                                Reserve your spot in one of our classes or
                                request information about private sessions.
                            </p>
                        </div>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Fill out the form below to book your class.
                        ...
                        <div className="mt-12 text-center">
                            ...
                            <p className="text-muted-foreground mb-6">
                                If you have questions about our classes or would
                                like to discuss private sessions, please don't
