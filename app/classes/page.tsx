                ...
                <div className="container relative z-10 px-4 md:px-6">
                    <div className="max-w-3xl mx-auto text-center text-white">
                        <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl font-light tracking-tight mb-6">
                            Our{' '}
                            <span className="font-medium italic">Classes</span>
                        </h1>
                        <p className="text-lg md:text-xl opacity-90 max-w-xl mx-auto">
                            Discover our specialized Pilates classes designed to
                ...
                <div className="container px-4 md:px-6">
                    <div className="text-center mb-16">
                        <h2 className="font-serif text-3xl md:text-4xl font-light mb-4">
                            Weekly{' '}
                            <span className="font-medium italic">Schedule</span>
                        </h2>
                        <p className="text-muted-foreground max-w-2xl mx-auto">
                            Find a class that fits your schedule. All classes
                ...
                <div className="container px-4 md:px-6">
                    <div className="grid md:grid-cols-2 gap-12 items-center max-w-4xl mx-auto">
                        <div>
                            ...
                            <p className="text-muted-foreground mb-6">
                                Our private sessions offer personalized
                                attention and customized programs tailored to
                                your specific needs and goals. Whether you're
                                recovering from an injury, preparing for a
                                specific event, or simply prefer one-on-one
                                instruction, María Laura will guide you through
                                a transformative Pilates experience.
                            </p>
                            <p className="text-muted-foreground mb-8">
                                Private sessions are available by appointment
                                and can be scheduled at your convenience.
                                Contact us to discuss your needs and book your
                                first session.
                            </p>
                            <Button asChild className="rounded-none">
...
const faqs = [
    {
        ...
        answer: 'No prior experience is necessary. Our instructor will guide you through each movement and provide modifications as needed to ensure you get the most out of your practice regardless of your experience level.',
    },
    {
        question: 'What should I wear to class?',
        answer: 'Comfortable, form-fitting clothing that allows you to move freely is recommended. Socks are optional but many clients prefer them for hygiene purposes.',
    },
    {
        question: 'How early should I arrive for class?',
        answer: 'Please arrive 10-15 minutes before your first class. For subsequent classes, we recommend arriving 5 minutes early.',
    },
    {
        question: 'What is your cancellation policy?',
        answer: 'Classes must be cancelled at least 24 hours in advance to avoid being charged.',
    },
    {
        question: 'Do you offer package discounts?',
        answer: 'Yes, we offer class packages of 4, 6, 8, and 12 classes at discounted rates.',
    },
]
